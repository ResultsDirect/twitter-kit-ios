...
@property (nonatomic, nonnull, readonly) id<TWTRSETweetAttachmentCustomCardViewProvider> attachment;

@end

@implementation TWTRSETweetCustomCardAttachmentView

- (instancetype)initWithCustomCardAttachment:(id<TWTRSETweetAttachmentCustomCardViewProvider>)attachment
{
